...
hold off;
title("Przybliżenie x użyciem jawnej metody Eulera przed fminsearch");
...
hold off
title("Przybliżenie y użyciem jawnej metody Eulera przed fminsearch");
...
plot(t,y_dok)
hold on;
% Funkcja dokładności dopasowania
Fun_Jy = @(args)...
...
hold off;
grid("on")
title("Przybliżenie y z użyciem jawnej metody Eulera po fminsearch")
legend("y dokładne", "y przybliżone");
xlabel("t");
ylabel("populacja");